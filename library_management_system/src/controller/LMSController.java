...
public class LMSController {
    ...
    /*searchCatalog will search our database for items specific to type. For example,
     if item is a book, we perform search on it's class members(Title, author, ISBN).
    ...
    public boolean register(String userID, String firstName, String lastName, String email, String passwd, Boolean isAdmin) {
